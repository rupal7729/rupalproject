							...
							<div class="col-sm-12" style="margin-top: 20px;padding: 20px;background-color: #e6ecf5;">
								...
								<div class="col-sm-6">
											<img src="<?php echo base_url(); ?>upload/<?php echo $ckey->photo; ?>" height="100" width="100" border="1" style="margin-left: 20px;">
											 <label id="btnshowupdadd" style="margin-left:20px;"><i class="fa fa-pencil-square-o fa-2x"></i></label>
											 <label id="btnshowupdadd" style="margin-left:20px;"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></label>
								</div>
